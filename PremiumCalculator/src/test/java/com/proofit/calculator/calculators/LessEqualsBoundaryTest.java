...
class LessEqualsBoundaryTest {

    private static CostCalculator calculator;

    @BeforeAll
    static void setUp() {
        calculator = new LessEqualsBoundary(BigDecimal.valueOf(0.5), BigDecimal.valueOf(0.75), BigDecimal.valueOf(100));
    }
    ...
    private static Stream<Arguments> arguments() {
        return Stream.of(
                ...
                Arguments.of(BigDecimal.valueOf(100), BigDecimal.valueOf(75)),
